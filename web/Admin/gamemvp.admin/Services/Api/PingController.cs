...
namespace gamemvp.admin.Api
{
    public class PingController : ZNxt.Net.Core.Services.ApiBaseService
    {
      ...
      : base(httpContextProxy, dBService, logger, responseBuilder)
        ...
        [Route(AdminConsts.SERVICE_API_PREFIX + "/ping", CommonConst.ActionMethods.GET, CommonConst.CommonValue.ACCESS_ALL)]
        public JObject Ping()
        {
